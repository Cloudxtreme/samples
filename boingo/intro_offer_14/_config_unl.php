...
if ($_GET['ref']=='unl'){
	...
	$template_meta_title = 'Unlimited Wi-Fi Throughout the Americas from Boingo';
} else {
	// this is for unlcj (commission junction)
	$scc = overrideSCCbyURL(/*default*/'WEBCMJ001');
	$signup_url = 'https://c01.client.boingo.com/signup/SignupStart.app?PROMO='.$promo.'&SCC='.$scc.'&AMT1=9.95&AFL=CJ';
	$template_meta_title = 'Unlimited Wi-Fi from Boingo';
}
...
$template_top_banner_image = 'top_banner_unl_995.png';
$template_top_banner_image_alt = 'SPECIAL WI-FI OFFER: SIGN UP FOR BOINGO UNLIMITED, NO CONTRACTS. NO MB FEES. HUGE SAVINGS! - SIGN UP NOW, '.$template_currency_price.' per month';
$template_signup_button_image = 'btn_unl_995.png';
