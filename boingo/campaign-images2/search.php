...
<label>File name</label><input class="display_block width_465" name="search" type="text" id="searchterms" /><br />
<label>Minimum Width</label><input name="width_min" type="text" class="display_block width_50" id="width_min" value="0" /><br />
<label>Maximum Width</label><input name="width_max" type="text" class="display_block width_50" id="width_max" value="99999" /><br />
...
$(document).ready(function(){
	...
	$('#searchterms, #width_min, #width_max').keyup(function(){
